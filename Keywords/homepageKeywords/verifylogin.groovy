...
class verifylogin {
	 ...
	 */
	@Keyword
	def checklogin(TestObject name,String expected,String check) {
		try {
	...
	@Keyword
	def Verifylogin(TestObject Name,String Expected, String Check) {
		checklogin(Name,Expected,Check)
	}
}