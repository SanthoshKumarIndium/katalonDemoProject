...
class verifyorderplaced {
	 ...
	 */
	@Keyword
	def checkorderplaced(TestObject name,String expected,String check) {
		try {
	...
	@Keyword
	def Verifyorderplaced(TestObject Name,String Expected, String Check) {
		checkorderplaced(Name,Expected,Check)
	}
}